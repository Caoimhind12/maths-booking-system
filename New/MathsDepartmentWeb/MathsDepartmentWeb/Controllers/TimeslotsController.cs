...
namespace MathsDepartmentWeb.Controllers
{
    public class TimeslotsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TimeslotID,Timeslots")] Timeslot timeslot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TimeslotID,Timeslots")] Timeslot timeslot)
        {
            if (ModelState.IsValid)
            {
